...
class BytecodeSyntaxHighlighter : SyntaxHighlighterBase() {
    companion object {
        val KEYWORD =
            TextAttributesKey.createTextAttributesKey("BYTECODE_KEYWORD", DefaultLanguageHighlighterColors.KEYWORD)
        val OPCODE = TextAttributesKey.createTextAttributesKey(
            "BYTECODE_OPCODE",
            DefaultLanguageHighlighterColors.FUNCTION_DECLARATION
        )
        val NUMBER =
            TextAttributesKey.createTextAttributesKey("BYTECODE_NUMBER", DefaultLanguageHighlighterColors.NUMBER)
        val STRING =
            TextAttributesKey.createTextAttributesKey("BYTECODE_STRING", DefaultLanguageHighlighterColors.STRING)
        val COMMENT =
            TextAttributesKey.createTextAttributesKey("BYTECODE_COMMENT", DefaultLanguageHighlighterColors.LINE_COMMENT)
